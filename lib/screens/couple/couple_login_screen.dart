...
class CoupleLoginScreen extends StatefulWidget {
  const CoupleLoginScreen({super.key});

  @override
  State<CoupleLoginScreen> createState() => _CoupleLoginScreenState();
}

class _CoupleLoginScreenState extends State<CoupleLoginScreen> {
    ...
    try {
      ...
      if (mounted) {
        if (authService.isCouple) {
          ...
          setState(() {
            _isLoading = false;
            _errorMessage = 'Cet utilisateur n\'a pas les permissions d\'accès.';
          });
        }
      }
    } catch (e) {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Connectez-vous pour modérer votre mariage',
